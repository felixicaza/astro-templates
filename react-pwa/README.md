...
This is the React PWA Template that is part of [Astro Templates](https://github.com/felixicaza/astro-templates).

Template with basic integrations, extra configurations for Astro, SEO schema, SVG icons support, configurations for island support with React and Progressive Web Apps (PWA) powered by [@vite-pwa/astro](https://github.com/vite-pwa/astro).
