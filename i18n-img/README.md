# 🚀 Astro i18n Img Template

This is the i18n-img template that is part of [Astro Templates](https://github.com/felixicaza/astro-templates).

Same as [i18n](https://github.com/felixicaza/astro-templates/tree/main/i18n) template but with [astro-imagetools](https://github.com/RafidMuhymin/astro-imagetools) integration for image processing.
...
```bash
npm create astro@latest -- --template felixicaza/astro-templates/i18n-img
```

With PNPM:

```bash
pnpm create astro@latest --template felixicaza/astro-templates/i18n-img
```
